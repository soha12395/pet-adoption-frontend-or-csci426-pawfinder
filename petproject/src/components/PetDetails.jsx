    ...
    <div className="pet-details-container">
      ...
      <div className="pet-details-card">
        <div className="pet-image-section">
          <img src={pet.image} alt={pet.name} className="pet-large-image" />
          <span className="adoption-badge">Available for Adoption</span>
        </div>
        ...
        <div className="pet-info-section">
          ...
          <div className="pet-stats">
            ...
            <div><strong>Color:</strong> {pet.color || "Golden"}</div>
